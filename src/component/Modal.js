        ...
        fetch("/createVenueEvent", {
            ...
            .then((data) => {
                if (typeof data !== "string") {
                    ...
                    toast.error("Event exists, pls change the event ID");
                else toast.error(data);
            });
    }
